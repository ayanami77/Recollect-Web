...
export const EditModal: FC<EditModalProps> = ({ content }) => {
	...
	const createdAtString = `${createdAt.getFullYear()}/${createdAt.getMonth() + 1}/${createdAt.getDate()}`
	const updatedAtString = `${updatedAt.getFullYear()}/${updatedAt.getMonth() + 1}/${updatedAt.getDate()}`
