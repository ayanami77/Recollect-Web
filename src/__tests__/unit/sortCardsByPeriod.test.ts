...
export const mockData: TCard[] = [
  ...
  {
    id: '85acf9d9-f101-4437-9f3c-0e31ae2e1b22',
    period: '0',
    title: '秋の新歓活動を頑張った話',
    content:
  ...
  {
    id: '6795e827-5273-4fbf-9ab7-0b1ace310dfb',
    period: '0',
    title: '進級制作展',
    content:
  ...
  {
    id: '6febb08a-6712-4f0e-9245-3a8a7fbbf786',
    period: '1',
    title: '秋の新歓活動を頑張った話',
    content:
      'プログラミングサークルの活動の一環として秋に新歓活動を行いました。新勧プロジェクトと称して、どのように人を集めるのか、広報の手法、新メンバー歓迎イベントなどを話し合い、一つ一つ実行していきました。自分にとっては不慣れなインスタグラムを使って、自ら進んでサークルの活動の様子を宣伝したり、サークルのメンバーにも協力を促したりしてなんとか新歓活動を進めていきました。最終的には新しいメンバーに入ってもらえたのでほっとしていました。',
...
describe('sortCardsByPeriod', () => {
  test('CardのArrayを時期ごとにKey-Valueへ変換する', () => {
    expect(sortCardsByPeriod(mockData)).toStrictEqual(mockOutput)
  })
})
